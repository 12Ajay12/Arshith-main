          ...
          <div className="container mx-auto px-4 md:px-6 max-w-4xl">
            ...
            <div className="space-y-4">
              {faqs.map((faq, i) => (
                ...
                >
                  <CollapsibleTrigger className="flex items-center justify-between w-full p-6 text-left bg-white rounded-2xl hover:shadow-md transition-all border border-gray-100">
                    <span className="text-xl font-serif font-bold pr-8 text-foreground">{faq.q}</span>
